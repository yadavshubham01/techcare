import layer7 from '../images/senior-woman-doctor-and-portrait-smile-for-health-2023-11-27-05-18-16-utc.png'
import layer8 from '../images/TestLogo.png'


export const Navbar = () => {
    return (
        <div className="bg-white w-full py-2 px-2 border-b border-gray-200 flex justify-between items-center rounded-full mb-2 mt-2">
             <div className="flex items-center ">
                        <img src={layer8} alt="Logo" className="mr-2"/>
            </div>
            <div className="flex items-center space-x-6">
                        <a href="#" className="text-gray-600 hover:text-gray-800 gap-2 flex items-center">
                        ...
                        <a href="" className="text-white bg-teal-500 hover:bg-teal-600 px-3 py-1 gap-2 rounded-full flex items-center">
            ...
            <div className="flex items-center">
                <img src={layer7} alt="Doctor" className="rounded-full mr-4"/>
                <div>
                    <h2 className="text-xl font-semibold">Dr. Jose Simmons</h2>
                    <div className="text-sm text-gray-500">General Practitioner</div>
                </div>
            </div>
            <div className="flex items-center space-x-4">
                <button className="text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" width="18.944" height="20" viewBox="0 0 18.944 20">
                ...
                <button className="text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" width="3.714" height="18" viewBox="0 0 3.714 18">
